type AsideMenuStatus = "open" | "closed";
type AsideMenuData = {
    asideMenuStatus: AsideMenuStatus;
};
type TriggerAsideMenuProps = {
    asideMenuData: AsideMenuData;
    asideMenuLinksNames: NodeListOf<HTMLAnchorElement>;
};

const asideMenuTriggerButton = document.getElementById(
    "aside-menu-trigger-button"
);
const asideMenuImage = document.getElementById(
    "aside-menu-image"
) as HTMLImageElement;
...
function closeAsideMenu({
    ...
    setTimeout(() => {
        asideMenuImage.src = "./assets/tudu_logo_inverted.png";
    }, 200);
}
...
if (asideMenuTriggerButton && asideMenu) {
    ...
    asideMenuTriggerButton.addEventListener("click", () => {
        const asideMenuData = asideMenu.dataset as AsideMenuData;
